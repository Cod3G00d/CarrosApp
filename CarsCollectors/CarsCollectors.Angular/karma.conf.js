...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/fabricantes/fabricantesModule.js',
			'app/modules/fabricantes/fabricantesCtrl.js',
			'app/modules/fabricantes/fabricantesRoute.js',
			'app/modules/fabricantes/fabricantesService.js',
			'app/modules/fabricantes/fabricantes-test.js',
			'app/modules/veiculos/veiculosModule.js',
			'app/modules/veiculos/veiculosCtrl.js',
			'app/modules/veiculos/veiculosRoute.js',
			'app/modules/veiculos/veiculosService.js',
			'app/modules/veiculos/veiculos-test.js',
		],
